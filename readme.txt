...
== Description ==
Millions of people are living in slavery around the world, even though most people think it died out in the 1800s. Over the last 20 years it has grown to become a $5 billion a year industry, making it the most lucrative criminal industry in the world behind drug trafficking.
...
You can help raise awareness by installing this plugin, which will add a ribbon to your website that links to [the Not For Sale campaign](http://www.notforsalecampaign.org). You can view the [screenshot](http://wordpress.org/extend/plugins/re-abolish-slavery-ribbon/screenshots/) for an example of how it will look.
